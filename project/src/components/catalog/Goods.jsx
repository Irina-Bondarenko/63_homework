   ...
   const clearAllFiltersButtonHandler = () => {
    ...
    return (
      <div className="goods-wrapper">
          <h2 className="qty-of-found">Founded {goods.length} of {allProductAmount}</h2>
          <div className="filter-reset">
              <Button onClick={clearAllFiltersButtonHandler} type="submit" variant="contained">Clear All Filters</Button>
          </div>
            <div className="goods">
              {goods.map((item) => (
